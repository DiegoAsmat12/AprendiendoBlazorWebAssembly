...
namespace AprendiendoBlazorWebAssembly.Server.Helpers
{
    public class AlmacenadorArchivosLocal : IAlmacenadorDeArchivos
    {
        ...
        public AlmacenadorArchivosLocal(IWebHostEnvironment environment,
        ...
        public Task EliminarArchivo(string ruta, string nombreContenedor)
        {
            ...
            string directorioArchivo = Path.Combine(environment.WebRootPath, nombreContenedor, filename);
        ...
        public async Task<string> GuardarArchivo(byte[] contenido, string extension, string nombreContenedor)
        {
            ...
            string folder = Path.Combine(environment.WebRootPath, nombreContenedor);
